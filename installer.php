...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210304_themewpv1_cecc5702fc0706115917_20210304055009_archive.zip';
	const ARCHIVE_SIZE		 = '86954624';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'cecc570-04055009';
    const SECONDARY_PACKAGE_HASH = '5cb3211-04055009';
	const VERSION			 = '1.4.0';
